...
Source0  : https://people.redhat.com/sgrubb/libcap-ng/libcap-ng-0.8.3.tar.gz
...
%prep
%setup -q -n libcap-ng-0.8.3
cd %{_builddir}/libcap-ng-0.8.3
pushd ..
cp -a libcap-ng-0.8.3 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649265495
...
cp %{_builddir}/libcap-ng-0.8.3/COPYING %{buildroot}/usr/share/package-licenses/libcap-ng/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/libcap-ng-0.8.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/libcap-ng/3ac522f07da0f346b37b29cd73a60f79e992ffba
pushd ../build32/
%make_install32
